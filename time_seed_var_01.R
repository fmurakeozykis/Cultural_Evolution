setwd("/home3/s5194326/floras_directory/var.compare/results/seed/time")
...
output_dir <- "time_seed_var_net01_r"
...
for (var in var_degree) {
  ...
  for (i in 1:10) {
    output_file <- file.path(output_dir, paste0("s_time_net01_var", var, "_run", i, ".RDS"))
